...
training_1['train'].extend(training_1['test'])  # for this assignment, combine testing and training data together
for case in training_1['train']:
    input = case['input']
    output = case['output']

    prediction = solve(input)
